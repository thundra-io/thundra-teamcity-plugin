...
import static io.thundra.foresight.teamcity.plugin.utils.ThundraUtils.API_KEY;
...
import static io.thundra.foresight.teamcity.plugin.utils.ThundraUtils.PROJECT_KEY;
...
public class GradleBuildForesightInitializer implements IBuildToolForesightInitializer{
    ...
    public void initialize(BuildRunnerContext runner, String agentPath) {
        try {
            ...
            final String scopeGradlePluginVersion = getPluginVersion();
            ...
            root.put(THUNDRA_GRADLE_PLUGIN_VERSION,
                    runner.getConfigParameters().getOrDefault(THUNDRA_GRADLE_PLUGIN_VERSION, scopeGradlePluginVersion));
            ...
            log.info("Thundra foresight gradle initialization failed");
        }
    ...
    private String getPluginVersion() throws XMLStreamException, IOException {
        ...
        log.info("Latest Plugin Version : " + latestPluginVersion);
